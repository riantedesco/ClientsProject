package com.compass.msclient.configuration;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.compass.msclient.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("API Msclient")
                .description("Documentação do msclient do desafio da Droga Raia")
                .version("1.0.0")
